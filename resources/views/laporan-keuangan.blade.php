...
<section class="content">
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-6">
        <h4><b>Laporan Keuangan {{ strtoupper(request()->segment(1)) }}</b></h4>
      </div>
    </div>
  ...
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('laporan-keuangan.export') }}" enctype="multipart/form-data" method="POST">
          @csrf
  ...
  <script type="text/javascript">
    ...
    function loadingData(){
      var table = $('#fikri-request').DataTable({
        serverSide: true,
        ajax: {
          url: "{{ route('laporan-keuangan.get-list') }}",
          type: 'POST',
          data: {
