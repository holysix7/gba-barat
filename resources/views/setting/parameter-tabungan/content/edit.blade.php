        ...
        <div class="m-4">
          <div class="row m-2 mt-4">
            <div class="d-flex w-100">
              <form method="POST" action="{{ route('setting.parametertabungan.edit', request()->segment(4)) }}" enctype="multipart/form-data" class="w-100">
                @csrf
                <div class="justify-content-center" id="formId">
                  <div class="row">
                    <div class="col-sm-6 form-group">
                      <label class="form-label-bold">ID</label>
                      <input type="text" class="form-control" name="sd_p_id" placeholder="ID" value="{{$record['current']->sd_p_id}}">
                    </div>
                    <div class="col-sm-6 form-group">
                      ...
                      <select class="form-control" name="sp_p_admin" id="sdPadminId" >
                        ...
                        @foreach($record['productSpdefs'] as $productSpdef)
                          <option value="{{$productSpdef->sd_ps_abstract_type}}" {{$record['current']->sp_p_admin == $productSpdef->sd_ps_abstract_type ? 'selected' : ''}}>{{$productSpdef->sd_ps_abstract_type}} - {{$productSpdef->subprocess ? $productSpdef->subprocess->sd_sdc_desc : '-'}}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-6 form-group">
                      ...
                      <input type="text" class="form-control" name="sd_p_name" placeholder="Nama Produk" value="{{$record['current']->sd_p_name}}">
                    </div>
                    <div class="col-sm-6 form-group">
                  ...
                  <div class="row">
                    <div class="col-sm-6 form-group">
                      ...
                      <input type="text" class="form-control uangMasking" name="sp_p_min_init_amount" placeholder="Minimal Setoran Awal" value="{{$record['current']->sp_p_min_init_amount}}">
                    </div>
                    <div class="col-sm-6 form-group">
                      ...
                      <select class="form-control" name="sp_p_group_account" >
                        ...
                        @foreach($record['groupAccounts'] as $groupAccount)
                          <option value="{{$groupAccount->sd_ga_id}}" {{ $record['current']->sp_p_group_account == $groupAccount->sd_ga_id ? 'selected' : ''}}>{{$groupAccount->sd_ga_name}}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-6 form-group">
                      ...
                      <input type="text" class="form-control uangMasking" name="sp_p_min_period_amount" placeholder="Minimal Setoran Periode" value="{{$record['current']->sp_p_min_period_amount}}">
                    </div>
                    <div class="col-sm-6 form-group">
                  ...
                  <div class="row">
                    <div class="col-sm-6 form-group">
                      ...
                      <input type="text" class="form-control uangMasking" name="sp_p_max_period_amount" placeholder="Maximal Setoran Periode" value="{{$record['current']->sp_p_max_period_amount}}">
                    </div>
                    <div class="col-sm-6 form-group">
                  ...
                  <div class="row">
                    <div class="col-sm-6 form-group">
                      ...
                      <input type="text" class="form-control uangMasking" name="sp_p_denom_period_amount" placeholder="Nominal Denomisasi" value="{{$record['current']->sp_p_denom_period_amount}}">
                    </div>
                    <div class="col-sm-6 form-group">
                  ...
                  <div class="row">
                    <div class="col-sm-6 form-group">
                      ...
                      <input type="number" class="form-control number-only" name="sp_p_min_period" placeholder="Minimal Jangka Waktu" value="{{$record['current']->sp_p_min_period}}">
                    </div>
                    <div class="col-sm-6 form-group">
                  ...
                  <div class="row">
                    <div class="col-sm-6 form-group">
                      ...
                      <input type="number" class="form-control number-only" name="sp_p_max_period" placeholder="Max Jangka Waktu" value="{{$record['current']->sp_p_max_period}}">
                    </div>
                    <div class="col-sm-6 form-group">
                  ...
                  <div class="row d-flex">
                    <div class="col-sm-6 form-group">
                      ...
                      <input type="number" class="form-control number-only" name="sp_p_max_period_fail" placeholder="Max Gagal Autodebet" value="{{$record['current']->sp_p_max_period_fail}}">
                    </div>
                    <div class="col-sm-6 form-group">
                      <label class="form-label-bold">Mata Uang</label>
                      <input type="text" class="form-control" name="sp_p_currency" value="IDR" readonly value="{{$record['current']->sp_p_currency}}">
                    </div>
                  </div>
                  <div class="row d-flex">
                    <div class="col-sm-6 form-group">
                      <label class="form-label-bold">Fee Admin</label>
                      <input type="text" class="form-control uangMasking" name="sp_p_external_admin" placeholder="Fee Admin" value="{{ $record['current']->sp_p_external_admin }}">
                    </div>
                    <div class="col-sm-6 form-group">
                      <label class="form-label-bold">Status</label>
                      <select class="form-control" name="sp_p_product_status">
                        <option value="1" {{ $record['current']->sp_p_product_status == 1 ? 'selected' : '' }}>Aktif</option>
                        <option value="2" {{ $record['current']->sp_p_product_status == 2 ? 'selected' : '' }}>Nonaktif</option>
                      </select>
                    </div>
                  </div>
