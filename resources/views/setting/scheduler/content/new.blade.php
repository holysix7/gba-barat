        ...
        <div class="m-4">
          <div class="row m-2 mt-4 justify-content-center">
            <div class="d-flex w-50">
              <form method="POST" action="{{ route('setting.scheduler.new') }}" enctype="multipart/form-data" class="w-100">
                @csrf
                <div class="justify-content-center" id="formId">
                  <div class="row">
                    <div class="col-sm-12 form-group">
                      <label class="form-label-bold">ID Scheduler</label>
                      <input type="number" class="form-control" name="sd_s_id" placeholder="ID Scheduler" maxlength="25" required>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-12 form-group">
                      <label class="form-label-bold">Nama Scheduler</label>
                      <input type="text" class="form-control" name="sd_s_name" placeholder="Nama Scheduler" maxlength="50" required>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-6 form-group">
                      <label class="form-label-bold">Waktu Mulai</label>
                      <input type="text" class="form-control" name="sd_s_start_time" placeholder="00:00" maxlength="5" required>
                    </div>
                    <div class="col-sm-6 form-group">
                      <label class="form-label-bold">Waktu Selesai</label>
                      <input type="text" class="form-control" name="sd_s_end_time" placeholder="00:00" maxlength="5" required>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-12 form-group">
                      <label class="form-label-bold">Deskripsi</label>
                      <textarea class="form-control" name="sd_s_description" placeholder="Deskripsi" rows="4" required></textarea>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-12 form-group">
