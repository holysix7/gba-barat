      ...
      <div class="row">
        <div class="card-body col-12">
          @if(request()->segment(4))
            @include('autodebit.lsbu.penutupan.content.show')
          @else
            @include('autodebit.lsbu.penutupan.content.content')
          @endif
        </div>
      </div>
    </div>
  ...
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('autodebit.lsbu.penutupan.export') }}" enctype="multipart/form-data" method="POST">
          @csrf
