    ...
    <div class="row 2">
      <div class="col-md-6">
        <h4><b>Monitoring </b> <label id="labelAutodebit"></label></h4>
          <p class="text-muted">Daftar Seluruh Rekening Sukses Autodebit</p>    
      </div>
  ...
  function loadTableSukses(){
    if ( $.fn.DataTable.isDataTable( '#table-riwayat-sukses' ) ) {
          ...
          $('#table-riwayat-sukses').DataTable({
            ...
            serverSide: true,
            ajax: {
              url: "{{ route('monitoring.transkasi.daftar-rekening.data') }}",
              type: 'GET',
              data: 
                function (d) {
                  var search_data = {
            ...
            columns: [
              ...
              {data: 'tanggal_autodebit', name: 'Tanggal Autodebit'}
            ],
