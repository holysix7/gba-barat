  ...
  <ul class="navbar-nav ml-auto">
    <li class="nav-item dropdown">
      <a class="nav-link" data-toggle="dropdown" href="#" style="color: #000000BF !important; font-weight: 600 !important;">
        {{ ucwords(Session::get('user')->nama) }}
        <img src="{{ asset('adminlte/dist/img/user.jpg') }}" class="img-circle" style="width: 30px; height: 30px; margin-left: 10px;" alt="{{ ucwords(Session::get('user')->nama) }}">
