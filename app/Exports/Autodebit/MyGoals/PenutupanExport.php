...
class PenutupanExport implements FromCollection, WithColumnFormatting, WithHeadings, ShouldAutoSize, WithEvents
{
  ...
  public function collection(){
    ...
    if($start_date){
      ...
      ->where(function($query){
        $query->where('a.sd_pc_status', 2)
        ->orWhere('a.sd_pc_status', 4);
      })
